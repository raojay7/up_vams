		...
		<div id="fh5co-main">
								...
								<div class="container">
									...
									<div class="row">
										<div class="col-md-3">
											...
											<img src="${basePath}lib_one/images/hafo-04.jpeg" class="img-circle img-responsive">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<h4 class="media-heading"></h4>
							<p>
							<span class="glyphicon glyphicon-bookmark" style="color: rgb(159, 192, 100); font-size: 29px;"></span>&nbsp;性别: 男 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
							</div>
							</li>
							...
							<div class="media-body">
							<h4 class="media-heading"></h4>
								<span class="glyphicon glyphicon-envelope" style="color: rgb(159, 192, 100); font-size: 29px;"></span>&nbsp;邮箱: 442961832@qq.com &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>

								<a class="btn btn-primary" href="#">发送邮件</a>
							...
							<h4 class="media-heading"></h4>
							<p>
							<span class="glyphicon glyphicon-star" style="color: rgb(159, 192, 100); font-size: 29px;"></span>&nbsp;积分: 230 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
							</div>
							</li>
							<li class="media">
							<div class="media-body">
			...
			<div class="section">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h2 class="section-heading">收藏的学校</h2>
						</div>
					</div>
				</div>
			</div>
			<div class="section">
				<div class="container">
					<div class="row">
						<div class="col-md-3">
							<img src="${basePath}lib_one/images/haf0-01.jpeg" class="img-responsive">
							<br>
							<h3 class="section-heading">南昌大学</h3>
							<p> 图片总数：1234
							<br>访问量：2234
							<br>活跃指数：88</p>
							<a class="btn btn-primary" href="#">访问主页</a>
							...
							<!--<ul class="media-list">-->
													...
													<!--<div class="modal-content">-->
														...
														<!--<div class="modal-body">-->
															<!--<div class="form-group">-->
																...
																<!--<input class="form-control" id="newName" placeholder="输入新昵称" type="text">-->
															<!--</div>-->
														<!--</div>-->
								...
								<!--<li class="media">-->
									<!--<div class="media-body">-->
										<!--<h4 class="media-heading"></h4>-->
										<!--<p>-->
											<!--<span class="glyphicon glyphicon-picture" style="color: rgb(159, 192, 100); font-size: 29px;"></span>&nbsp;我的头像：-->
											<!--<br>-->
											<!--<br>-->
											<!--<img class="media-object" src="${basePath}lib_one/images/hafo-05.jpeg" height="64" width="64">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
											<!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
											<!--&lt;!&ndash;-->
                                            <!--按钮触发模态框 &ndash;&gt;-->
											<!--<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#changeImg">更换头像</button>-->
											<!--&lt;!&ndash; 模态框（Modal） &ndash;&gt;-->
										<!--</p>-->
										<!--<form action="#" method="post">-->
								...
								<!--<li class="media">-->
									<!--<div class="media-body">-->
										<!--<h4 class="media-heading"></h4>-->
										<!--<p>-->
											<!--<span class="glyphicon glyphicon-bookmark" style="color: rgb(159, 192, 100); font-size: 29px;"></span>&nbsp;性别: 男 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
											<!--&lt;!&ndash;-->
                                            <!--按钮触发模态框 &ndash;&gt;-->
											<!--<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal2">修改</button>-->
											<!--&lt;!&ndash; 模态框（Modal） &ndash;&gt;-->
										<!--</p>-->
