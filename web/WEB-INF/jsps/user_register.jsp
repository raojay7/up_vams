...
<div id="fh5co-page-title" style="background-image: url(${basePath}lib_one/images/ncu-bg.jpg)">
            ...
            <div class="col-md-3" id="fh5co-sidebar">
                <div class="fh5co-side-block">
                    ...
                    <ul class="fh5co-links">
                        <li><a href="#" target="_blank">哈佛大学</a></li>
                        <li><a href="#" target="_blank">斯坦福</a></li>
                        <li><a href="#" target="_blank">MIT</a></li>
                        <li><a href="#" target="_blank">南昌大学</a></li>
                        <li><a href="#" target="_blank">北京大学</a></li>
                    </ul>
                </div>
                <div class="fh5co-side-block">
                    <h3>推荐的展览</h3>
                    ...
                    100多个学校，10000多张优美的图片。
                    我们通过相似聚类，爆炸的展示在一个小小网页里，绝对让你叹为观止。

                    </p>
                    <p><a href="#" class="btn btn-outline btn-sm">前往观赏</a></p>
                </div>
            ...
            <div class="col-md-8 col-md-push-1" id="fh5co-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="fh5co-uppercase-heading-sm text-center">欢&nbsp;&nbsp;&nbsp;迎&nbsp;&nbsp;&nbsp;新&nbsp;&nbsp;&nbsp;用&nbsp;&nbsp;&nbsp;户</h2>
                                ...
                                <form action="${basePath}user/register.do" method="post">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input placeholder="Email@example.com" name="userEmail" id="name"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input placeholder="输入密码" id="password" name="userPassword" type="password"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input placeholder="确认密码" id="password1" name="password1" type="password"
                                                   class="form-control input-lg">
                                        </div>
                                    </div>
