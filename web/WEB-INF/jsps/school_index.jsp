	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					<li class="fh5co-active"><a href="school_index.html">学校简介</a></li>
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content animate-box fh5co-border-bottom" data-animate-effect="fadeInLeft">
				<h2 class="fh5co-heading" >南昌大学</span></h2>
				<p>
  				南昌大学简介
			</p>
				...
				<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-2">
							<a class="btn btn-outline">图片总数 345</a>
						</div>
						...
						<div class="col-md-3">
							<a class="btn btn-outline">访问量  1234</a>
						</div>

						<div class="col-md-3">
							<a class="btn btn-outline">活跃指数 66</a>
						</div>
						...
						<div class="col-md-2">
							<a class="btn btn-outline">学校排名 1</a>
						</div>
