...
<div id="fh5co-page">
    ...
    <div id="fh5co-main">
        ...
        <div class="fh5co-narrow-content animate-box fh5co-border-bottom" data-animate-effect="fadeInLeft">
            <h2 class="fh5co-heading">${school.schoolName}</h2>
            <p>
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a class="btn btn-outline">访问量 ${school.schoolPageView}</a>
                    </div>

                    <div class="col-md-3">
                        <a class="btn btn-outline">活跃指数 ${school.schoolActiveIndex}</a>
                    </div>
                    ...
                    <div class="col-md-2">
                        <a class="btn btn-outline">学校排名 ${school.schoolRanking}</a>
                    </div>
