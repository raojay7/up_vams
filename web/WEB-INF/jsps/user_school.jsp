...
<div id="fh5co-page">
    ...
    <aside id="fh5co-aside" role="complementary" class="border js-fullheight">
        ...
        <nav id="fh5co-main-menu" role="navigation">
            <ul>
                <li><a href="${basePath}user/photoUI.do">我收藏的图片</a></li>
                <li class="fh5co-active"><a href="${basePath}user/schoolUI.do">我收藏的学校</a></li>
    ...
    <div id="fh5co-main">
        <div class="fh5co-gallery">
            ...
            <c:forEach items="${pageResult.list}" var="school">
                <a class="gallery-item" href="${basePath}school/find.do?schoolId=${school.schoolId}">
                    <img src="${picPath}${school.photo.photoOssname}" alt="school_door" width="350px" height="400px">
                    <span class="overlay">
        ...
        <script type="text/javascript">
            ...
            function doGoPage(pageNum) {
                ...
                document.forms[0].action = "${request.getContextPath}/schoolUI.do";
