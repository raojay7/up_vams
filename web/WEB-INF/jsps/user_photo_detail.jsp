	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border">
			...
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					...
					<li><a href="${basePath}user/friend/recommendUI.do">神友的推荐</a></li>a href="user_friend_recommend.html">神友的推荐</a></li>
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content animate-box fh5co-border-bottom" data-animate-effect="fadeInLeft">
				<h2 class="fh5co-heading" >图片标题</span></h2>
				<p><p>
				   图片简介
			    </p></p>
				...
				<div class="row">
					...
					<div class="col-md-12">
					<p class="text-center"><a href="#" class="btn btn-primary btn-outline">取消收藏</a></p>
					</div>
