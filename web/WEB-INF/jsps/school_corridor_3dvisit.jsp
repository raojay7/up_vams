		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					...
					<li class="fh5co-active"><a href="${basePath}school/corridor_3dvisitUI.do">3D走廊游览</a></li>
			...
			<div class="fh5co-gallery">
				...
				<div class="section">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-6">
								<img src="${basePath}lib_one/images/3d.png"
							...
							<div class="col-md-6">
								...
								<p>
									<a class="btn btn-lg btn-outline" href="${basePath}virtual/test-demo.html">前往游览</a>
								</p>
							</div>
						</div>
					</div>
