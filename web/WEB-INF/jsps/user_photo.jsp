	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					<li class="fh5co-active"><a href="${basePath}user/photo.do">我收藏的图片</a></li>
					<li><a href="${basePath}user/school.do">我收藏的学校</a></li>
					<li><a href="${basePath}user/profile.do">账户信息</a></li>
					<li><a href="${basePath}user/friend.do">我关注的神友</a></li>
					<li><a href="${basePath}user/friend/recommend.do">神友的推荐</a></li>
				</ul>
			</nav>
