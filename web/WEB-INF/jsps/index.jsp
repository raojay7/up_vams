          ...
          <div class="col-md-4">
            <div class="feature-item">
              ...
              <div class="feature-text">
                ...
                <p>
                  <br>
                  <a href="#"> <img style="width: 120px;height: 120px" src="${basePath}lib_one/images/st-icon.jpg"/> </a></p>
                <p>
                  扫描上面二维码关注我们。
                </p>
              </div>
            ...
            <div class="row first-row">
              <div class="col-md-6 col-sm-6">
                <a href="${basePath}lib_one/images/main-learning-building.jpg" class="img image-popup">
                  ...
                  <img src="${basePath}lib_one/images/main-learning-building.jpg" alt="Image" class="img-responsive">
                </a>
              </div>
              <div class="col-md-6 col-sm-6">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6">
                <a href="${basePath}lib_one/images/ncu-main-playground.jpg" class="img image-popup">
                  ...
                  <img src="${basePath}lib_one/images/ncu-main-playground.jpg" alt="Image" class="img-responsive">
                </a>
              </div>
              <div class="col-md-6 col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4">
            <a href="${basePath}lib_one/images/ncu-playground-night.jpg" class="img image-popup">
              ...
              <img src="${basePath}lib_one/images/ncu-playground-night.jpg" alt="Image" class="center-block img-circle img-responsive">
            </a>

            <h3 class="text-center">清华大学</h3>
            <p class="text-center"><a href="${basePath}virtual/test-demo.html" class="btn btn-primary">进入体验</a></p>
          </div>
          ...
          <div class="col-md-4">
            <a href="${basePath}lib_one/images/ncu-door.jpg" class="img image-popup">
              ...
              <img src="${basePath}lib_one/images/ncu-door.jpg" alt="Image" class="center-block img-circle img-responsive">
            </a>
          ...
          <div class="col-md-4">
            <a href="${basePath}lib_one/images/hafo-05.jpeg" class="img image-popup">
              ...
              <img src="${basePath}lib_one/images/hafo-05.jpeg" alt="Image" class="center-block img-circle img-responsive">
            </a>
